...
import edu.wm.cs.cs301.isabellawu.gui.P5PanelF21.P5RenderingHints;
...
public class CompassRose {
    ...
    private static final int CIRCLE_HIGHLIGHT = -855638017;	// new Color(1.0f, 1.0f, 1.0f, 0.8f); , alpha = 204
    //Color.decode("#115740").darker();// = new Color(1.0f, 1.0f, 1.0f, 0.8f); 
    private static final int CIRCLE_SHADE = 1308622847;		// new Color(1.0f, 1.0f, 1.0f, 0.3f); , alpha = 77
    //Color.decode("#115740").brighter(); //new Color(0.0f, 0.0f, 0.0f, 0.2f); 
    
    // fixed configuration for letters used to indicate direction
    private static final int MARKER_COLOR = -16777216;	// black
    ...
    /**
     * Paint a compass rose on the given MazePanel object.
	...
	private void drawBorderCircle(MazePanel panel, int width) {
		...
		// draw both arcs      
        panel.setColor(1.0f, 1.0f, 1.0f, 0.3f);		// CIRCLE_SHADOW
        panel.addArc(x, y, w, w, 45, 180);
        panel.setColor(1.0f, 1.0f, 1.0f, 0.8f);		// CIRCLE_HIGHLIGHT
