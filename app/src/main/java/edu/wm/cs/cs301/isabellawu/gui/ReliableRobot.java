...
public class ReliableRobot implements Robot {
	...
	public int[] getCurrentPosition() throws Exception {
		...
		if(currentPosition[0] < 0 || currentPosition[0] >= controller.getMazeConfiguration().getWidth() || 
				currentPosition[1] < 0 || currentPosition[1] >= controller.getMazeConfiguration().getHeight()) {
	...
	public void jump() {
		...
		if(controller.getCurrentPosition()[0] == 0 && getCurrentDirection() == CardinalDirection.West) {
			crashed = true;
		}
		else if(controller.getCurrentPosition()[0] == controller.getMazeConfiguration().getWidth()-1 && getCurrentDirection() == CardinalDirection.East) {
			crashed = true;
		}
		else if(controller.getCurrentPosition()[1] == 0 && getCurrentDirection() == CardinalDirection.North) {
			crashed = true;
		}
		else if(controller.getCurrentPosition()[1] == controller.getMazeConfiguration().getHeight()-1 && getCurrentDirection() == CardinalDirection.South) {
			crashed = true;
		}
	...
	public boolean isAtExit() {
		if(controller.getCurrentPosition()[0] == controller.getMazeConfiguration().getExitPosition()[0] && 
				controller.getCurrentPosition()[1] == controller.getMazeConfiguration().getExitPosition()[1]) {
			return true;
		}
		return false;
	}
	...
	public boolean isInsideRoom() {
		if(controller.getMazeConfiguration().isInRoom(controller.getCurrentPosition()[0], controller.getCurrentPosition()[1])) {
			return true;
		}
		return false;
	}
	...
	public int distanceToObstacle(Direction direction) {		
		...
		case LEFT: {
			...
			try {
				...
				dist = sensor_left.distanceToObstacle(controller.getCurrentPosition(), getCurrentDirection(), battery);
			} catch (Exception e) {
				e.printStackTrace();
			}
			break;
		...
		case RIGHT: {
			...
			try {
				...
				dist = sensor_right.distanceToObstacle(controller.getCurrentPosition(), getCurrentDirection(), battery);
			} catch (Exception e) {
				e.printStackTrace();
			}
			break;
		...
		case FORWARD: {
			...
			try {
				...
				dist = sensor_forward.distanceToObstacle(controller.getCurrentPosition(), getCurrentDirection(), battery);
			} catch (Exception e) {
				e.printStackTrace();
			}
			break;
		...
		case BACKWARD: {
			...
			try {
				...
				dist = sensor_backward.distanceToObstacle(controller.getCurrentPosition(), getCurrentDirection(), battery);
			} catch (Exception e) {
				e.printStackTrace();
			}
			break;
