...
import edu.wm.cs.cs301.isabellawu.generation.Order.Builder;
...
public class Controller {
    ...
    RobotDriver driver;
    /**
     * The string of 0s and 1s that represents the configuration of Reliable 
     ...
     */
     ...
     /**
     * Returns the controller's reliability variable
     * @return string of 0s and 1s representing the configuration of
     * the robot's sensors.
     */
     ...
     /**
     * Sets the controller's reliability variable
     * @param r the string of 0s and 1s representing the configuration of
     * the robot's sensors.
     */
     public void setReliability(String r) {
    	 reliability = r;
     }
